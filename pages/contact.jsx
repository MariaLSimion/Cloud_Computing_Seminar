...
<div className="grid grid-cols-1 gap-4 md:grid-cols-3">
  ...
  <div href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <a href="https://cloud-computing-seminar-virtual-shelf-proj-mxh4qtwdl.vercel.app" className="font-normal text-blue-500 hover:underline dark:text-gray-400">https://cloud-computing-seminar-virtual-shelf-proj-mxh4qtwdl.vercel.app</a>
  </div>
</div>
